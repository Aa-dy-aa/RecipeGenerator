  ...
  return (
    <div className='p-10 border rounded-xl shadow-sm mt-5'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
            <div>
                <h2 style={{ color: '#FF7B74' }} className='font-bold text-2xl'>{recipe?.recipeOutput?.recipeName}</h2>
                ...
                <Button style={{ backgroundColor: '#FF7B74' }} className='w-full mt-5'>Start</Button>
            </div>
            <div>
               {animationData && (
